...
namespace CursorAiming
{
    ...
    //        var spawnedEnemy = new EnemyWithGun(new Gun("PlayerGun1", "laserBlue01", 1, 500, UnitType.Player, Game),
    //                100, 100, 1d, "BasicEnemy", 100, 100, 100, Game)
    //            {Position = newEnemyPosition};

    //        var spawnedEnemy1 = new MeleeEnemy(300, 1, "spaceAstronaut_red", 20, 20, 20, Game);

    //        EnemyUnitsOnField.Add(spawnedEnemy1);
    //    }
